...
stores_tbl      <- read_excel(path  = "C:/Users/tiend/Documents/GitHub/ss23-bdml-tiend96/Challenge1/breakfast_at_the_frat.xlsx", 
                              sheet = "dh Store Lookup",
                              skip  = 1)
products_tbl    <- read_excel(path  = "C:/Users/tiend/Documents/GitHub/ss23-bdml-tiend96/Challenge1/breakfast_at_the_frat.xlsx", 
                              sheet = "dh Products Lookup",
                              skip  = 1)
transaction_tbl <- read_excel(path  = "C:/Users/tiend/Documents/GitHub/ss23-bdml-tiend96/Challenge1/breakfast_at_the_frat.xlsx",
